#ifndef OBSTACLE_FILTER_H_
#define OBSTACLE_FILTER_H_
...
{
static constexpr int8_t DISABLE_OBSTACLE = 99;
static constexpr int8_t ENABLE_OBSTACLE = 1;

class ObstacleFilter : public Layer
{
public:
    ObstacleFilter();
...
private:
    ...
    void setHeightObstacle(double max_obstacle_height);
